...
int main(){
	...
	try{
		...
		cout << "after put 6 items : ";
		cout << (queue.isFull() ? "YES, it is full\n" : "NO, it isn't full\n");

		// get size of the queue now
		cout << "size now is : " << queue.getLength() << endl;
		...
		// see if the size is redused & print the front to ensure from dequing 
		cout << "after dequing the front the Length now is : " << queue.getLength() << endl;
