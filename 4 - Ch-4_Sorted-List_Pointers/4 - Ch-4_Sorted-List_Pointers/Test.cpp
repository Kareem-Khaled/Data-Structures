...
int main(){
	...
	*/
	...
	list.resrtList();
	cout << "after removing "; item.print(); cout << " from the list Length now is : " << list.getLength() << endl;
	cout << "Items are : ";
	for (int i = 0; i < list.getLength(); i++){
		list.getNextItem().print();
		cout << " \n"[i + 1 == list.getLength()];
	...
	/*
		check if item 8 is exist or not.
	...
	*/
	...
	// comparing two items
	item1.initialize("Kareem");
	item2.initialize("Ahmed");
	item1.print();
